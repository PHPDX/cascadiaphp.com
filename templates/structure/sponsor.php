...
<div class="flex p2 sponsor">
    <amp-layout layout="responsive" width="1" height="1" sizes="(min-width: 40em) calc((1440px - 14em) / 3), calc(100vw - 6em)" class="shadow-md shadow-inner circle b-<?= $borderColor ?? 'black' ?> bg-<?= $backgroundColor ?? 'white' ?>">
