...
<section id="footer" class="text-center flex flex-column justify-center content-center dark bg-gravel white relative py2">
    <div class="md-flex lg-flex flex-lg-column-reverse reverse justify-center">
        <div class="legal flex flex-column md-items-end lg-items-end justify-center">
    ...
    <div>
        <ul class="social-icons list-reset flex justify-center items-center flex-wrap m0 mt2">
            <li>
                <a href="https://twitter.com/cascadiaphp" target="_blank" class="inline-block px1 flex" aria-label="Link to Cascadia PHP Twitter">
            ...
            <li>
                <a href="https://github.com/phpdx/cascadiaphp.com" target="_blank" class="inline-block px1 flex" aria-label="Link to Cascadia PHP Github">
            ...
            <li>
                <a href="https://www.facebook.com/cascadiaconf" class="inline-block flex px1 text-shadow" target="_blank" aria-label="Link to Cascadia PHP Facebook">
