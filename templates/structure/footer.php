...
<section id="footer" class="text-center flex flex-column justify-center content-center dark bg-gravel white relative px3">
    <div class="flex">
        <div class="flex flex-column items-start col-6 col justify-center">
            <div class="white col-8">
                <span class="nowrap text-shadow darkblue">&copy; <?= $this->e(date('Y')); ?></span> <span class="nowrap text-shadow darkblue">Cascadia PHP</span>
            </div>
        </div>
        <div class="flex flex-column col-6 items-end col justify-center right-align">
    ...
    <div>
        <ul class="ampstart-social-follow list-reset flex justify-center items-center flex-wrap m0 mt2">
            <li>
