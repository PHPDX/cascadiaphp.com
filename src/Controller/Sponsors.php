...
class Sponsors extends Controller
{
    ...
    {
        $this->seo()
            ->setTitle('Companies that helped make Cascadia PHP 2019 happen')
            ->setDescription('Cascadia PHP 2019 could not happen if not for our sponsors. They worked with us ' .
